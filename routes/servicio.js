...
router.post('/agregar', [
    ...
    check('areatrabajo', 'El area de trabajo No puede tener más de 20 caracteres').isLength({ max: 30 }),
    ...
    check('fechaInicio', 'La fecha de inicio No puede tener más de 10 caracteres').isLength({ max: 30 }),
